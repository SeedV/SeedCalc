  ...
  SubShader {
    ...
    Pass {
      ...
      fixed4 frag(v2f i) : SV_Target {
        ...
        fixed gridMask = GetGridMask(_GridColor, _GridDimension, _GridLineWidth, i.uv);
        fixed secondaryMask =
        ...
        fixed3 blend =
            saturate(_GridColor.rgb * gridMask +
                _SecondaryGridColor.rgb * secondaryMask * (1 - gridMask) +
